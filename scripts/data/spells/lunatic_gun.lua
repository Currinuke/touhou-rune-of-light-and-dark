local spell, super = Class(Spell, "lunatic_gun")
...
function spell:onCast(user, target)
    user.chara:addFlag("lunaticguns_used", 1)
...
function spell:getDamage(user, target)
    ...
    local damage = (attack + magic - 10) * 20 + MathUtils.random(30)
